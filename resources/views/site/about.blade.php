        ...
        <div class="row justify-content-center ">
          <div class="col-lg-6 text-center ">
            ...
            <div class="mb-5 text-white desc mx-auto" data-aos="fade-up" data-aos-delay="200">
              <p>Another free template by <a href="https://untree.co/" target="_blank" class="link-highlight">Untree.co</a>. Far far away, behind the word mountains, far
                from the countries
    ...
    <div class="row">
      <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="0">
        <div class="staff text-center">
          <div class="mb-4"><img src="/assets/images/staff_1.jpg" alt="Image" class="img-fluid"></div>
      ...
      <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="staff text-center">
          <div class="mb-4"><img src="/assets/images/staff_2.jpg" alt="Image" class="img-fluid"></div>
          <div class="staff-body">
      ...
      <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="200">
        <div class="staff text-center">
          <div class="mb-4"><img src="/assets/images/staff_3.jpg" alt="Image" class="img-fluid"></div>
          <div class="staff-body">
    ...
    <div class="row">
      ...
      <div class="col-lg-7 ml-auto" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="custom-accordion" id="accordion_1">
          ...
          <div class="accordion-item">
            <h2 class="mb-0">
              <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">We Value
                Good Characters</button>
            </h2>
                ...
                <div class="d-flex">
                  ...
                  <div>
                    <p>When she reached the first hills of the Italic Mountains, she had a last view
                      ...
                      the Line Lane.</p>
                    <p>Pityful a rethoric question ran over her cheek, then she continued her way.
                    </p>
                  </div>
                </div>
